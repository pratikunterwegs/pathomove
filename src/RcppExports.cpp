...
S4 run_pathomove(const int scenario, const int popsize, const int nItems,
                 ...
                 const bool evolve_sI, const float mProb, const float mSize,
...
RcppExport SEXP _pathomove_run_pathomove(
    ...
    SEXP infect_percentSEXP, SEXP verticalSEXP, SEXP evolve_sISEXP,
  ...
  rcpp_result_gen = Rcpp::wrap(run_pathomove(
      ...
      multithreaded, dispersal, infect_percent, vertical, evolve_sI, mProb,
      mSize, spillover_rate));
  return rcpp_result_gen;
  END_RCPP
}
