...
RcppExport SEXP _pathomove_run_pathomove(
    ...
    SEXP g_patho_initSEXP, SEXP range_foodSEXP, SEXP range_agentsSEXP,
    SEXP range_moveSEXP, SEXP handling_timeSEXP, SEXP regen_timeSEXP,
    SEXP pTransmitSEXP, SEXP initialInfectionsSEXP, SEXP costInfectSEXP,
    SEXP multithreadedSEXP, SEXP dispersalSEXP, SEXP infect_percentSEXP,
    SEXP verticalSEXP, SEXP reprod_thresholdSEXP, SEXP mProbSEXP,
    SEXP mSizeSEXP, SEXP spillover_rateSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  rcpp_result_gen = Rcpp::wrap(run_pathomove(
      ...
      dispersal, infect_percent, vertical, reprod_threshold, mProb, mSize,
      spillover_rate));
  return rcpp_result_gen;
  END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    {"_pathomove_get_test_landscape", (DL_FUNC)&_pathomove_get_test_landscape,
     5},
    {"_pathomove_run_pathomove", (DL_FUNC)&_pathomove_run_pathomove, 25},
