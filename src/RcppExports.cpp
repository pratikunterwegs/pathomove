...
S4 run_pathomove(const int scenario, const int popsize, const int nItems,
                 ...
                 const float spillover_rate, const int seed);
RcppExport SEXP _pathomove_run_pathomove(
    ...
    SEXP regen_timeSEXP, SEXP pTransmitSEXP, SEXP p_vTransmitSEXP,
    SEXP initialInfectionsSEXP, SEXP costInfectSEXP, SEXP multithreadedSEXP,
    SEXP dispersalSEXP, SEXP infect_percentSEXP, SEXP verticalSEXP,
    SEXP evolve_sISEXP, SEXP reprod_thresholdSEXP, SEXP mProbSEXP,
    SEXP mSizeSEXP, SEXP spillover_rateSEXP, SEXP seedSEXP) {
  BEGIN_RCPP
  Rcpp::RObject rcpp_result_gen;
  Rcpp::RNGScope rcpp_rngScope_gen;
  ...
  rcpp_result_gen = Rcpp::wrap(run_pathomove(
      ...
      reprod_threshold, mProb, mSize, spillover_rate, seed));
  return rcpp_result_gen;
  END_RCPP
}
