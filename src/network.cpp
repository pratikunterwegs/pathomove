...
//     SEXP graph = graph_from_adjmat(adjMat, Rcpp::Named("diag")=false,
//     Rcpp::Named("weighted")=true);
...
//         static_cast<float>(vDiam[0]) * (static_cast<float>(nVertices) /
//         static_cast<float>(vSize[0])) // global efficiency
//     };
