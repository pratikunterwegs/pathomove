...
run_pathomove <- function(scenario = 2L, popsize = 100L, nItems = 1800L, landsize = 60.0, nClusters = 60L, clusterSpread = 1.0, tmax = 100L, genmax = 100L, g_patho_init = 70L, range_food = 1.0, range_agents = 1.0, range_move = 1.0, handling_time = 5L, regen_time = 50L, pTransmit = 0.05, initialInfections = 20L, costInfect = 0.25, multithreaded = TRUE, dispersal = 2.0, infect_percent = FALSE, vertical = FALSE, reprod_threshold = FALSE, mProb = 0.01, mSize = 0.01, spillover_rate = 1.0) {
